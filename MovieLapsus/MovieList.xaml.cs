...
namespace MovieLapsus
{
    public sealed partial class MovieList : Page
    {
        ...
        private async void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            var movieList = e.NavigationParameter as IEnumerable<MovieInfoByID_Cast>;

            foreach (var movie in movieList)
            {
                var dataItem = new SampleDataItem(movie.id.ToString(),
            ...
            this.DefaultViewModel["Group"] = dataGroup;
        }
